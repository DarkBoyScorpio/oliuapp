...
if menu == "📥 Nhập đơn hàng":
    ...
    with st.form("form_nhap_don"):
        ...
        with st.expander("🍯 Mật ong, Mắm, Điều", expanded=False):
            col1, col2 = st.columns(2)
            with col1:
                mat_ong_500ml = st.number_input("🍯 Mật ong 500ml", min_value=0, step=1, disabled=True)
            ...
            with col2:
                ...
                mam_1l = st.number_input("🥫 Mắm 1 lít", min_value=0, step=1, disabled=True)
        ...
        with st.expander("🍱 Rau củ quả - trái cây sấy", expanded=False):
            ...
            with col1:
                ...
                ktrb_250g = st.number_input("🥔 Khoai tây rong biển 250g", min_value=0, step=1, disabled=True)
            ...
            with col2:
                ...
                ktrb_500g = st.number_input("🥔 Khoai tây rong biển 500g", min_value=0, step=1, disabled=True)
                ktmam_500g = st.number_input("🥔 Khoai tây mắm 500g", min_value=0, step=1, disabled=True)
                km_trung_cua_500g = st.number_input("🍠 Khoai môn trứng cua 500g", min_value=0, step=1, disabled=True)
                chuoi_500g = st.number_input("🍌 Chuối sấy mộc 500g", min_value=0, step=1, disabled=True)
        ...
        with st.expander("🍚 Cơm cháy, Bánh tráng mắm", expanded=False):
            ...
            with col1:
                ...
                banh_trang_mam = st.number_input("🥖 Bánh tráng mắm", min_value=0, step=1, disabled=True)
            with col2:
